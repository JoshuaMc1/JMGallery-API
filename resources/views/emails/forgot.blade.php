...
<head>
    ...
    <title>JMGallery - Restablecer contraseña</title>
    <!--[if (mso 16)]>
<style type="text/css">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Le hemos enviado este correo electrónico en
                                                                        respuesta a su solicitud de restablecer su
                                                                        contraseña.

                                                                        Para restablecer su contraseña, siga el
                                                                        siguiente enlace:</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
...
style="height:31px; v-text-anchor:middle; width:183px" arcsize="50%" stroke="f" fillcolor="#13315c">
<w:anchorlock></w:anchorlock>
<center style='color:#efefef; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:11px; font-weight:700; line-height:11px; mso-text-raise:1px'>Confirmar cuenta</center>
</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="es-button-border msohide"
                                                                        style="border-style:solid;border-color:#474745;background:#13315c;border-width:0px;display:inline-block;border-radius:20px;width:auto;mso-border-alt:10px;mso-hide:all"><a
                                                                            href="http://localhost:5173/change/{{ $token }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#EFEFEF;font-size:16px;display:inline-block;background:#13315c;border-radius:20px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:19px;width:auto;text-align:center;padding:6px 25px 6px 25px;border-color:#13315c">Restablecer
                                                                            Contraseña</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    style="padding:0;Margin:0;padding-top:15px">
                                                                    <span
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#505050;font-size:14px">
                                                                        Ignore este mensaje si no ha solicitado un
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                        <strong>JMGallery</strong> ©<strong>
                                                                            2023</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
